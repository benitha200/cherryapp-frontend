...
//               batchNo: `Combined-${grade}-${new Date().toISOString().slice(0, 10)}`,  // Use a combined batch name with date
//               gradeGroup: 'LOW',
...
//           );
//         } else {
//           // Handle individual batch transfers as before
//           gradeItems.forEach(groupedItem => {
//             groupedItem.records.forEach(originalRecord => {
//               const gradeDetails = {};
...
//                   isGroupedTransfer: false,  // Explicitly set to false for individual transfers
//                   truckNumber: transportDetails.truckNumber,
//                   driverName: transportDetails.driverName,
//                   driverPhone: transportDetails.driverPhone,
//                   notes: transportDetails.notes
...
//                                       </p>
//                                       <Form.Group controlId={`combined-${grade}-bags`}>
//                                         <Form.Label>Number of Bags for all {grade} batches</Form.Label>
//                                         <Form.Control
//                                           type="number"
//                                           min="1"
//                                           placeholder={`Enter total bags for ${grade}`}
//                                           value={combinedLowGradeBags[grade] || ''}
//                                           onChange={(e) => handleCombinedBagsChange(grade, e.target.value)}
//                                           required
//                                         />
//                                         <Form.Text className="text-muted">
//                                           All {items.length} batches of {grade} will share these bags
//                                         </Form.Text>
//                                       </Form.Group>
//                                     </Card.Body>
//                                   </Card>
...
//                                 {/* Individual Batch Details - only shown if not grouped for low grades */}
//                                 {(!isLowGrade || !lowGradeGrouping[grade]?.isGrouped) && items.map(item => (
//                                   <Card key={item.id} className="mb-3">
//                                     <Card.Header style={{ backgroundColor: processingTheme.tableHover }}>
//                                       <div className="d-flex justify-content-between align-items-center">
//                                         <span className="fw-bold">{item.batchNo} - {item.grade} - {item.kgValue.toFixed(2)} kg</span>
//                                         <Badge bg={item.isHighGrade ? "success" : "info"}>
//                                           {item.isHighGrade ? "High Grade" : "Low Grade"}
//                                         </Badge>
//                                       </div>
//                                     </Card.Header>
//                                     <Card.Body>
//                                       <Row>
//                                         {/* For High Grade, show Cup Profile and Moisture Content */}
//                                         {item.isHighGrade && (
//                                           <>
//                                             <Col md={4}>
//                                               <Form.Group className="mb-3" controlId={`cupProfile-${item.id}`}>
//                                                 <Form.Label>Cup Profile</Form.Label>
//                                                 <Form.Select
//                                                   required
//                                                   value={gradeQualityDetails[`${item.recordId}-${grade}`]?.cupProfile || CUP_PROFILES[0]}
//                                                   onChange={(e) => handleQualityDetailsChange(item.recordId, grade, 'cupProfile', e.target.value)}
//                                                 >
...
//                                                   onChange={(e) => handleQualityDetailsChange(item.recordId, grade, 'moistureContent', e.target.value)}
//                                                 />
//                                               </Form.Group>
//                                             </Col>
//                                           </>
...
//                                         {/* For all grades, show number of bags */}
//                                         <Col md={item.isHighGrade ? 12 : 6}>
...
//                                               onChange={(e) => handleQualityDetailsChange(item.recordId, grade, 'numberOfBags', e.target.value)}
//                                             />
//                                           </Form.Group>
//                                         </Col>
//                                       </Row>
...
//       {/* Updated Available Grade Items Table */}
//       <Card className="mb-4">
//         <Card.Header style={{ backgroundColor: processingTheme.neutral }}>
//           <div className="d-flex justify-content-between align-items-center">
//             <span className="h5" style={{ color: processingTheme.primary }}>
...
//                     <Form.Check
//                       type="checkbox"
//                       checked={selectedGradeItems.length > 0 &&
//                         selectedGradeItems.length === flattenBatchRecords().length}
...
//                       {searchTerm ? 'No matching records found' : 'No untransferred coffee available'}
//                     </td>
//                   </tr>
//                 ) : (
...
//                         <Button
//                           size="sm"
//                           variant={isGradeItemSelected(item.gradeKey) ? "outline-danger" : "outline-success"}
...
//               </li>
//               {Array.from(
//                 { length: Math.ceil(flattenBatchRecords().length / batchesPerPage) },
//                 (_, i) => i + 1
//               ).map((number) => (
//                 <li
//                   key={number}
...
//                 >
//                   <button className="page-link bg-sucafina" onClick={() => paginate(number)}>
//                     {number}
//                   </button>
//                 </li>
//               ))}
//               <li
//                 className={`page-item ${currentPage === Math.ceil(flattenBatchRecords().length / batchesPerPage)
//                   ? 'disabled'
//                   : ''
//                   }`}
//               >
...
//                   onClick={() => paginate(currentPage + 1)}
//                   disabled={
//                     currentPage === Math.ceil(flattenBatchRecords().length / batchesPerPage)
//                   }
//                 >
//                   Next
//                 </button>
